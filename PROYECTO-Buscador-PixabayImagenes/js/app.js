...
function mostrarAlerta(mensaje) {
    ...
    if (!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'text-red-700', 'px-4', 'py-3',
            'rounded', 'max-w-lg', 'max-auto', 'mt-6', 'text-center');
...
function buscarImagenes() {
    ...
    const key = '40934613-d862ee81a4b1288052f060f26';
...
function mostrarImagenes(imagenes) {
    ...
    //iterar sobre el arreglo de imagenes y construit el HTML 
...
function imprimirPaginador() {
    ...
    while (true) {
        ...
        boton.classList.add('siguiente', 'mb-4', 'bg-yellow-400', 'px-4', 'py-1', 'mr-2', 'font-bold', 'rounded');
